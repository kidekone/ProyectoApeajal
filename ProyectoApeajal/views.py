...
def index(request):
    if request.user.is_authenticated:
        datos = pd.read_csv("/home/apeajal/Apeajal/ProyectoApeajal/static/csv/certificados.csv")
        ...
        datosP = pd.read_csv("/home/apeajal/Apeajal/ProyectoApeajal/static/csv/certificados.csv")
